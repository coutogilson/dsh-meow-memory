...
- remember.error.keywordsEmpty: memory_remember: keywords arrived but no keyword could be parsed out of it (received {received}) — pass a string array, or comma-separated text, and try again
